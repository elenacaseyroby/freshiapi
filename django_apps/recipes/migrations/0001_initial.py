...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('qty_numerator', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('qty_denominator', models.PositiveSmallIntegerField(blank=True, null=True)),
                ('notes', models.CharField(blank=True, max_length=100, null=True)),
                ('food', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='foods.food')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servings_count', models.PositiveSmallIntegerField(blank=True, null=True)),
                ...
                ('ingredients_in_nutrition_facts', models.DecimalField(blank=True, decimal_places=2, max_digits=3, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='recipe',
            name='categories',
            field=models.ManyToManyField(blank=True, through='recipes.RecipeCategory', to='recipes.Category'),
        ),
        migrations.AddField(
            model_name='recipe',
        ...
        migrations.AddField(
            model_name='recipe',
            name='source',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='recipes.source'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='user_photos',
