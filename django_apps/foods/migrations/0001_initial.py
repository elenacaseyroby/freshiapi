    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('one_serving_display_qty', models.DecimalField(
                    blank=True, decimal_places=2, max_digits=5)),
                ('one_serving_display_unit', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dv_qty', models.DecimalField(decimal_places=2,
                                               max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_unit', models.ForeignKey(
                    ...
                    related_name='from_unit', to='foods.unit')),
                ('to_unit', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='to_unit', to='foods.unit')),
            ],
        ),
        migrations.CreateModel(
            name='NutritionFact',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.RESTRICT, to='foods.unit'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through='foods.NutritionFact', to='foods.Nutrient'),
        ),
        migrations.AddField(
            model_name='food',
            name='one_serving_unit',
            field=models.ForeignKey(
                blank=True, on_delete=django.db.models.deletion.RESTRICT,
                to='foods.unit'),
        ),
        migrations.AddField(
            model_name='food',
