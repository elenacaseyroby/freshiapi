# Generated by Django 3.1.5 on 2021-02-10 17:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('dv_unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='foods.unit')),
                ('usdanutrients', models.ManyToManyField(blank=True, to='foods.USDANutrient')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='food',
            name='nutrients',
            field=models.ManyToManyField(blank=True, through='foods.FoodNutrient', to='foods.Nutrient'),
        ),
        migrations.AddField(
            model_name='food',
